  ...
  grunt.initConfig({
    ...
    uglify: {
      ...
      bootstrap: {
        ...
        dest: '../../sites/bootstrap_pivotalenergy_net/static/js/<%= pkg.name %>.min.js'
      }
    },
    ...
    recess: {
      ...
      bootstrap: {
        ...
        dest: '../../sites/bootstrap_pivotalenergy_net/static/css/<%= pkg.name %>.css'
      },
      min: {
        options: {
          compress: true
        ...
        src: ['less/bootstrap.less'],
        dest: '../../sites/bootstrap_pivotalenergy_net/static/css/<%= pkg.name %>.min.css'
      },
      theme: {
        src: ['less/theme.less'],
...
//  grunt.registerTask('test', testSubtasks);
  ...
  grunt.registerTask('dist', ['clean', 'test', 'dist-css', 'dist-fonts', 'dist-js']);
