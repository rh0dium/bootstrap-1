...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            bootstrap: {
                src: ['js/affix.js', 'js/alert.js', 'js/button.js', 'js/carousel.js', 'js/collapse.js', 'js/datepicker.js', 'js/dropdown.js', 'js/fileupload.js', 'js/modal.js', 'js/popover.js', 'js/scrollspy.js', 'js/tab.js', 'js/tooltip.js', 'js/transition.js', ],
        ...
        uglify: {
            ...
            bootstrap: {
                files: {
                    '../../sites/bootstrap_pivotalenergy_net/static/js/<%= pkg.name %>.min.js': ['<%= concat.bootstrap.dest %>']
                }
            }
        },
        qunit: {
